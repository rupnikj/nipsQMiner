...
QMiner is available as open source project on GitHub under AGPL licence. The repository contains source code, introduction guide and complete documentations of QMiner JavaScript APIs.We will first present the core components of the library and then present some examples using the javascript API.
